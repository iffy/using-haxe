...
static const ::String _hx_array_data_acbd8395_24[] = {
...
HXLINE( 356)			::Sys_obj::command(HX_("/usr/bin/open",5c,58,a2,62),::Array_obj< ::String >::__new(1)->init(0,path));
            		}
            	}
...
HXLINE( 479)			::String seperator = HX_("/",2f,00,00,00);
...
HXLINE( 727)			::lime::_hx_system::System_obj::_hx___deviceModel = ::lime::_hx_system::System_obj::_hx___runProcess(HX_("sysctl",ae,bd,d5,f2),::Array_obj< ::String >::fromData( _hx_array_data_acbd8395_24,2));
            		}
...
HXLINE( 751)			::lime::_hx_system::System_obj::_hx___deviceVendor = HX_("Apple",3a,f5,68,b7);
            		}
...
HXLINE( 846)			::String name = ::lime::_hx_system::System_obj::get_platformName();
HXLINE( 847)			::String version = ::lime::_hx_system::System_obj::get_platformVersion();
HXLINE( 848)			bool _hx_tmp;
HXDLIN( 848)			if (hx::IsNotNull( name )) {
HXLINE( 848)				_hx_tmp = hx::IsNotNull( version );
            			}
            			else {
HXLINE( 848)				_hx_tmp = false;
            			}
HXDLIN( 848)			if (_hx_tmp) {
HXLINE( 848)				::lime::_hx_system::System_obj::_hx___platformLabel = ((name + HX_(" ",20,00,00,00)) + version);
            			}
            			else {
HXLINE( 849)				if (hx::IsNotNull( name )) {
HXLINE( 849)					::lime::_hx_system::System_obj::_hx___platformLabel = name;
            				}
            			}
            		}
...
HXLINE( 866)			::lime::_hx_system::System_obj::_hx___platformName = HX_("macOS",73,51,16,03);
            		}
...
HXLINE( 913)			::lime::_hx_system::System_obj::_hx___platformVersion = ::lime::_hx_system::System_obj::_hx___runProcess(HX_("sw_vers",6b,99,f9,43),::Array_obj< ::String >::fromData( _hx_array_data_acbd8395_34,1));
            		}
