...
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_689_setFrameRate,"lime._backend.native.NativeApplication","setFrameRate",0xfc951cf7,"lime._backend.native.NativeApplication.setFrameRate","lime/_backend/native/NativeApplication.hx",689,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_702_updateTimer,"lime._backend.native.NativeApplication","updateTimer",0x8a9bcb30,"lime._backend.native.NativeApplication.updateTimer","lime/_backend/native/NativeApplication.hx",702,0xb13849fd)
HX_LOCAL_STACK_FRAME(_hx_pos_2f2697aaa7d6e1ad_731_updateTimer,"lime._backend.native.NativeApplication","updateTimer",0x8a9bcb30,"lime._backend.native.NativeApplication.updateTimer","lime/_backend/native/NativeApplication.hx",731,0xb13849fd)
namespace lime{
namespace _backend{
namespace native{
...
HXLINE( 362)			if ((keyCode == (int)102)) {
HXLINE( 364)				if ((type == (int)0)) {
HXLINE( 366)					bool _hx_tmp;
HXDLIN( 366)					bool _hx_tmp1;
HXDLIN( 366)					if (this->toggleFullscreen) {
HXLINE( 366)						if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE( 366)							_hx_tmp1 = ::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(modifier);
            						}
            						else {
...
HXLINE( 366)						if (!(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier))) {
HXLINE( 366)							_hx_tmp = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(modifier));
            						}
            						else {
...
HXLINE( 368)						this->toggleFullscreen = false;
HXLINE( 370)						if (!(window->onKeyDown->canceled)) {
HXLINE( 372)							window->set_fullscreen(!(window->_hx___fullscreen));
            						}
            					}
            				}
            				else {
HXLINE( 380)					this->toggleFullscreen = true;
            				}
            			}
            		}
            	}
...
HXLINE( 641)					window->onEnter->dispatch();
            				...
            				break;
            				case (int)4: {
HXLINE( 645)					window->onExpose->dispatch();
            				}
            				break;
            				case (int)5: {
HXLINE( 649)					window->onFocusIn->dispatch();
            				}
            				break;
            				case (int)6: {
HXLINE( 653)					window->onFocusOut->dispatch();
            				}
            				break;
            				case (int)7: {
HXLINE( 657)					window->onLeave->dispatch();
            				}
            				break;
            				case (int)8: {
HXLINE( 661)					window->_hx___minimized = true;
HXLINE( 662)					window->onMinimize->dispatch();
            				}
            				break;
            				case (int)9: {
HXLINE( 666)					window->_hx___x = this->windowEventInfo->x;
HXLINE( 667)					window->_hx___y = this->windowEventInfo->y;
HXLINE( 668)					window->onMove->dispatch(this->windowEventInfo->x,this->windowEventInfo->y);
            				}
            				break;
            				case (int)10: {
HXLINE( 672)					window->_hx___width = this->windowEventInfo->width;
HXLINE( 673)					window->_hx___height = this->windowEventInfo->height;
HXLINE( 674)					window->onResize->dispatch(this->windowEventInfo->width,this->windowEventInfo->height);
            				}
            				break;
            				case (int)11: {
HXLINE( 678)					window->_hx___fullscreen = false;
HXLINE( 679)					window->_hx___minimized = false;
HXLINE( 680)					window->onRestore->dispatch();
            				}
            				break;
            			}
            		}
...
Float NativeApplication_obj::setFrameRate(Float value){
            	HX_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_689_setFrameRate)
HXLINE( 692)		::lime::_backend::native::NativeCFFI_obj::cffi_lime_application_set_frame_rate(hx::DynamicPtr(this->handle),value);
HXLINE( 694)		return (this->frameRate = value);
            	}
...
void NativeApplication_obj::updateTimer(){
            	HX_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_702_updateTimer)
HXDLIN( 702)		if ((::haxe::Timer_obj::sRunningTimers->length > (int)0)) {
HXLINE( 704)			int currentTime = ::lime::_hx_system::System_obj::getTimer();
HXLINE( 705)			bool foundNull = false;
HXLINE( 706)			 ::haxe::Timer timer;
HXLINE( 708)			{
HXLINE( 708)				int _g1 = (int)0;
HXDLIN( 708)				int _g = ::haxe::Timer_obj::sRunningTimers->length;
HXDLIN( 708)				while((_g1 < _g)){
HXLINE( 708)					_g1 = (_g1 + (int)1);
HXDLIN( 708)					int i = (_g1 - (int)1);
HXLINE( 710)					timer = ::haxe::Timer_obj::sRunningTimers->__get(i).StaticCast<  ::haxe::Timer >();
HXLINE( 712)					if (hx::IsNotNull( timer )) {
HXLINE( 714)						if ((currentTime >= timer->mFireAt)) {
HXLINE( 716)							 ::haxe::Timer timer1 = timer;
HXDLIN( 716)							timer1->mFireAt = (timer1->mFireAt + timer->mTime);
HXLINE( 717)							timer->run();
            						}
            					}
            					else {
HXLINE( 723)						foundNull = true;
            					}
            				}
            			}
HXLINE( 729)			if (foundNull) {
            				HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            				bool _hx_run( ::haxe::Timer val){
            					HX_STACKFRAME(&_hx_pos_2f2697aaa7d6e1ad_731_updateTimer)
HXLINE( 731)					return hx::IsNotNull( val );
            				}
            				HX_END_LOCAL_FUNC1(return)

HXLINE( 731)				::haxe::Timer_obj::sRunningTimers = ::haxe::Timer_obj::sRunningTimers->filter( ::Dynamic(new _hx_Closure_0()));
            			}
            		}
            	}
