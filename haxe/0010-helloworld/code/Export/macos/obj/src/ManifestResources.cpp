...
HXLINE(  56)		{
HXLINE(  56)			::String v = (rootPath + HX_("lib/library.json",c5,70,e7,f0));
HXDLIN(  56)			::lime::utils::Assets_obj::libraryPaths->set(HX_("library",fb,26,70,3f),v);
            		}
HXLINE(  57)		{
HXLINE(  57)			::String v1 = (rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  57)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v1);
            		}
HXLINE(  60)		library = ::lime::utils::Assets_obj::getLibrary(HX_("library",fb,26,70,3f));
HXLINE(  61)		if (hx::IsNotNull( library )) {
HXLINE(  61)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  62)			::ManifestResources_obj::preloadLibraryNames->push(HX_("library",fb,26,70,3f));
            		}
HXLINE(  63)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  64)		if (hx::IsNotNull( library )) {
HXLINE(  64)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  65)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
