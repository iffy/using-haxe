...
HX_LOCAL_STACK_FRAME(_hx_pos_b537b97081e2aab9_78_init,"lime.media.AudioManager","init",0x83630824,"lime.media.AudioManager.init","lime/media/AudioManager.hx",78,0x63af6ea2)
...
HXDLIN(  31)		if (hx::IsNull( ::lime::media::AudioManager_obj::context )) {
            			...
            			void _hx_run(){
            				HX_GC_STACKFRAME(&_hx_pos_b537b97081e2aab9_78_init)
HXLINE(  78)				::lime::_backend::native::NativeCFFI_obj::cffi_lime_al_cleanup();
            			}
...
HXLINE(  75)			 ::haxe::Timer timer =  ::haxe::Timer_obj::__alloc( HX_CTX ,(int)100);
HXLINE(  76)			timer->run =  ::Dynamic(new _hx_Closure_0());
            		}
            	}
